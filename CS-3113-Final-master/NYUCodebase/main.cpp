...
void titleScreen(){
	...
	modelMatrixMain.Translate(-5.0, 0.0, 0);
	DrawText(program, textSheet, "Hello", 2.0, 0.0005f);
	program->setModelMatrix(modelMatrixOver);
	modelMatrixOver.identity();
	modelMatrixOver.Translate(-5.0, -2.0, 0.0f);
	DrawText(program, textSheet, "CS 3113 Final", 2.0, 0.0005f);
