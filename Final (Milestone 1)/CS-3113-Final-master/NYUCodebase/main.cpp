...
void titleScreen(){
	...
	while (title){
		...
		modelMatrixMain.Translate(-2.0, 0.0, 0);
		DrawText(program, textSheet, "Hello", 4.0, 0.0005f);
		//program->setModelMatrix(modelMatrixOver);
		//modelMatrixOver.identity();
		//modelMatrixOver.Translate(-2.0, -1.0, 0.0f);
		//DrawText(program, textSheet, "CS 3113 Final", 4.0, 0.0005f);
